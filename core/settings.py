...
# settings.py
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r"core\fine-avatar-430307-f9-0abfb5f93304.json"
...
# HOSTs List
ALLOWED_HOSTS = ['localhost', '127.0.0.1','.vercel.app','192.168.106.216','172.18.142.106','192.168.222.41']
